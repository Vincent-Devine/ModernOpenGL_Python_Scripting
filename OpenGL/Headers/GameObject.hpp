...
namespace LowRenderer
{
	...
	protected:
		...
		pybind11::module * scriptMove;
		pybind11::module* scriptJump;
		pybind11::module* scriptDeathZone;
	...
	public:
		...
		void SetScriptMove(pybind11::module* p_scriptMove) { scriptMove = p_scriptMove; };
		void SetScriptJump(pybind11::module* p_scriptJump) { scriptJump = p_scriptJump; };
		void SetScriptDeathZone(pybind11::module* p_scriptDeathZone) { scriptDeathZone = p_scriptDeathZone; };
