...
namespace LowRenderer
{
	...
	void GameObject::Update(const Core::Inputs& p_Inputs, const double p_deltaTime,const Physics::Transform& p_transformParent)
	{
		...
		{
			scriptMove->attr("PlayerMove")(p_Inputs, &rigidbody, rigidbody.GetTransform(), playerControler.forwardCam, playerControler.rightCam);
			scriptJump->attr("PlayerJump")(p_Inputs, &rigidbody, collider, playerControler, p_deltaTime);
			scriptDeathZone->attr("Update")(&transform);
		}
