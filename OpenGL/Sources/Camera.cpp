...
namespace LowRenderer
{
	...
	{
		Physics::Transform gizmo = Physics::Transform(front, right, up);
		scriptMove->attr("Update")(p_Inputs, &transform, &rotationAroundPlayer, p_transformParent, &gizmo, &viewMatrix);
		front = gizmo.translation;
		right = gizmo.scale;
		up = gizmo.rotation;
	}
